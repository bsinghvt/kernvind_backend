...
async def bot_list(user_id:int):
    ...
    try:
        botxrefs =  BotUserXref.filter(user_id=user_id).prefetch_related(
        ...
        user: User
        bot: Bot
        user_bots: List[GetBot] = []
        async for botxref in botxrefs:
            ...
            user_bots.append(GetBot(bot_id=bot.bot_id,
