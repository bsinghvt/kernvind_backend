    ...
    try:
        async with in_transaction() as connection:
            ...
            if datasource_in.datasource_feed.datafeedsource_id == 'Google drive':
                try:
                    folder_name = await google_drive_user_creds_validation(access_key=access_key, folder_id=datasource_in.datasource_feed.datafeed_source_unique_id)
                ...
                datasource_in.datasource_feed.datafeed_source_title = folder_name
